-- ============================================
-- SCRIPT FINAL: Funcionalidad de Canales en Posts
...
-- 3. Función para obtener posts por canal (manteniendo estructura actual)
...
-- 4. Función para verificar permisos de publicación
...
-- 5. Función para obtener canales donde usuario puede publicar
...
-- 6. Función para usuario_puede_acceder_canal (si no existe)
...
-- 7. Política RLS para posts con canales (eliminar si existe y recrear)
...
-- 8. Política para insertar posts (verificar permisos de canal)

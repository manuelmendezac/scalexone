-- ============================================
-- SCRIPT FINAL SIN ERRORES: Funcionalidad de Canales en Posts
...
-- 3. ELIMINAR POLÍTICAS que dependen de las funciones
...
-- 4. ELIMINAR funciones existentes para evitar conflictos de tipo
...
-- 7. Función para obtener posts por canal
...
-- 8. Función para obtener canales donde usuario puede publicar
...
-- 9. RECREAR Política RLS para posts con canales
...
-- 10. RECREAR Política para insertar posts (verificar permisos de canal)
...
BEGIN
    ...
    IF EXISTS (
        ...
        WHERE tablename = 'comunidad_posts' 
        AND policyname = 'Usuarios pueden ver posts de canales accesibles'
    ) THEN
    ...
    IF EXISTS (
        SELECT 1 FROM pg_policies 
        WHERE tablename = 'comunidad_posts' 
        AND policyname = 'Usuarios pueden insertar posts en canales permitidos'
    ) THEN

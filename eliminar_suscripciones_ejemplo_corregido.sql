-- =====================================================
-- ELIMINAR SUSCRIPCIONES DE EJEMPLO - SCALEXONE CORREGIDO
-- =====================================================

-- 1. Eliminar las suscripciones de ejemplo del marketplace (corrigiendo nombres de columnas)
DELETE FROM cursos_marketplace 
WHERE instructor = 'ScaleXone' 
  AND titulo LIKE '%Premium%';
...
SELECT 
  ...
  (SELECT COUNT(*) FROM cursos_marketplace WHERE instructor = 'ScaleXone') as cursos_scalexone,
  (SELECT COUNT(*) FROM servicios_marketplace WHERE proveedor = 'ScaleXone') as servicios_scalexone;

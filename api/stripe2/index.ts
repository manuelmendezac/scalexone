...
console.log('[STRIPE2] Clave presente:', !!stripeKey, 'Longitud:', stripeKey ? stripeKey.length : 0);
...
export default async function handler(req: NextApiRequest, res: NextApiResponse) {
  ...
  console.log('[STRIPE2] Body recibido:', req.body);
  ...
  try {
    ...
    console.error('[STRIPE2] Error en Stripe API:', error);
